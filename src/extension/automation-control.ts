...
const ACTIONS : QmlAutomationActionDescription[] = [
    ...
    { action: "dap.loadedSources", sessionRequired: true, description: "Run the DAP loadedSources request.", requiredArgs: [] },
    { action: "dap.exceptionInfo", sessionRequired: true, description: "Run the DAP exceptionInfo request.", requiredArgs: [ "threadId" ] },
    ...
    { action: "dap.setExpression", sessionRequired: true, description: "Assign an expression in the active QML runtime.", requiredArgs: [ "expression", "value" ] },
    { action: "dap.setVariable", sessionRequired: true, description: "Assign a variable or object property in the active QML runtime.", requiredArgs: [ "variablesReference", "name", "value" ] },
...
const SESSION_REQUESTS : { [action : string] : string } = {
    ...
    "dap.loadedSources": "loadedSources",
    "dap.exceptionInfo": "exceptionInfo",
    "dap.stackTrace": "stackTrace",
    "dap.scopes": "scopes",
    "dap.variables": "variables",
    "dap.evaluate": "evaluate",
    "dap.setExpression": "setExpression",
    "dap.setVariable": "setVariable",
    "dap.pause": "pause",
